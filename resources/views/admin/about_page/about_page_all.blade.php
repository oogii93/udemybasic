   ...
   {{ $aboutpage->long_description }}
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($about_image->about_image))? url('upload/home_slide/'.$about_image->about_image):url('upload/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
